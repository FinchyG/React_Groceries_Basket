...
export default class Chicken extends React.Component {
    ...
    quantity_plus_one() {
        ...
        if(this.state.quantity >= 1) {
            ...
            this.setState((quantity) => ({quantity: item_quantity_plus_one}));
            let total_price = (item_quantity_plus_one * this.state.price).toFixed(2);
            document.getElementById("chicken_li").innerHTML = this.state.name + " " + item_quantity_plus_one + " " + "£" + total_price;
    ...
    quantity_minus_one() {
        ...
        if(item_quantity >= 1) {
            ...
            document.getElementById("chicken_li").innerHTML = this.state.name + " " + item_quantity + " " + "£" + total_price;
