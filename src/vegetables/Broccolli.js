...
export default class Broccolli extends React.Component {
    ...
    add_to_basket() {
        ...
        if(this.state.add_to_basket === true) {
            ...
            li.setAttribute("id", "broccolli_li");
    ...
    quantity_plus_one() {
        ...
        if(this.state.quantity >= 1) {
            ...
            this.setState((quantity) => ({quantity: item_quantity_plus_one}));
            let total_price = (item_quantity_plus_one * this.state.price).toFixed(2);
            document.getElementById("Broccolli_li").innerHTML = this.state.name + " " + item_quantity_plus_one + " " + "£" + total_price;
    ...
    quantity_minus_one() {
        ...
        if(item_quantity >= 1) {
            ...
            document.getElementById("broccolli_li").innerHTML = this.state.name + " " + item_quantity + " " + "£" + total_price;
    ...
    remove_from_basket() {
        ...
        if(this.state.quantity >= 1) {
            ...
            var li = document.getElementById("Broccolli_li");
